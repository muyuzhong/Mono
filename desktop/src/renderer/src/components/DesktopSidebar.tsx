    ...
    <aside className="sidebar" aria-label="工作区与会话">
      ...
      <div className="sidebar-body">
        ...
        <footer className="sidebar-footer">
          <button type="button" className={isSettingsOpen ? "active" : ""} aria-label="打开设置" aria-current={isSettingsOpen ? "page" : undefined} onClick={onOpenSettings}><Settings aria-hidden="true" size={16} /></button>
